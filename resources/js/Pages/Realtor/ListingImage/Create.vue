<template>
    <Box class="border-none">
        ...
        <div class="label font-bold mt-3">Upload new images</div>
        <form @submit.prevent="upload">
            ...
            <div v-if="imageError.length" class="error">
    ...
    <Box v-if="listing.images.length" class="border-none mt-4">
        <div class="label font-bold mt-3">Current listing images</div>
        <section class="mt-4 grid grid-cols-3 gap-4">
            ...
            >
                ...
                <Link
                    ...
                    method="delete"
                    as="button"
                    class="mt-2 btn-outline-danger text-xs"
                    ><i class="fas fa-trash pr-1"></i>Delete</Link
                >
            </div>
        </section>
    </Box>
